...
async function sendPasswordResetEmail({ email, name, token }, config = process.env) {
  ...
  const logoPath = path.resolve(__dirname, '../../frontend/public/assets/tatui-imoveis-share.png');
